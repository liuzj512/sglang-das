...
class ServerArgs:
    ...
    record_nolora_graph: A[bool, "Record no-lora graph.", NS("exec.moe")] = True
    ...
    def _validate_mamba_extra_buffer(self, view, model_arch: str):
        ...
        assert (
            is_cuda() or is_musa() or is_npu() or is_hcu() or is_hip() or is_xpu()
        ), "extra_buffer needs CUDA/MUSA/NPU/HCU/ROCm/XPU (FLA)."
