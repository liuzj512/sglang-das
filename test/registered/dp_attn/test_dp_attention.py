...
register_hcu_ci(
    ...
    suite="nightly-hcu",
    nightly=True,
    disabled="HCU CSV CI placeholder: DP attention path needs BW1100 multi-device validation before enabling.",
)
...
register_cuda_ci(est_time=445, stage="base-b", runner_config="2-gpu-large")
