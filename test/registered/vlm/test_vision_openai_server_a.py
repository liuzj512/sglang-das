...
register_hcu_ci(
    ...
    nightly=False,
    disabled="HCU CSV CI placeholder: VLM OpenAI server path needs local VLM model mapping before enabling.",
)
...
register_cuda_ci(est_time=576, stage="base-b", runner_config="1-gpu-large")
