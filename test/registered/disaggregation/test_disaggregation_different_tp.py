...
register_hcu_ci(
    ...
    suite="nightly-hcu",
    nightly=True,
    disabled="HCU CSV CI placeholder: disaggregation different-TP path needs BW1100 multi-device validation before enabling.",
)
...
register_cuda_ci(est_time=1175, stage="base-c", runner_config="8-gpu-h20")
