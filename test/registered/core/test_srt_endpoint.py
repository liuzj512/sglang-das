...
register_hcu_ci(est_time=130, suite="stage-b-test-1-hcu-small", disabled='HCU Full Enabled run 26941698027 failed; keep disabled until BW1100 failure is fixed or revalidated.')
...
register_cuda_ci(est_time=257, stage="base-b", runner_config="1-gpu-small")
