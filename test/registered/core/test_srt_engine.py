...
register_hcu_ci(
    ...
    disabled=(
        "HCU Full Enabled run 26941698027 failed; keep disabled until "
        "BW1100 failure is fixed or revalidated."
    ),
)
...
register_cuda_ci(est_time=273, stage="base-b", runner_config="1-gpu-large")
