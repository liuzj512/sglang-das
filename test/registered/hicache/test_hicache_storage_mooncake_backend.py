...
register_hcu_ci(
    ...
    suite="nightly-hcu",
    nightly=True,
    disabled="HCU CSV CI placeholder: Mooncake HiCache backend needs storage/runtime validation before enabling.",
)
...
register_cuda_ci(est_time=392, stage="base-b", runner_config="2-gpu-large")
