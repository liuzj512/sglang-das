...
register_hcu_ci(est_time=1100, suite="nightly-hcu-perf", nightly=True, disabled='HCU Full Enabled run 26941698027 failed; keep disabled until BW1100 failure is fixed or revalidated.')
...
register_cuda_ci(est_time=1263, stage="extra-a", runner_config="1-gpu-large")
